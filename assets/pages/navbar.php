...
<div class="nav" id="navbar">
    <nav class="nav__container">
        <div>
            ...
            <div class="nav__list">
                ...
                <div class="nav__items">
                    ...
                    <a href="?home" class="nav__link active" id="navhome">
                ...
                <div class="nav__items">
                    ...
                    if (getUnreadNotificationsCount() > 0) {
                        ?>
                        <a href="?notif" class="nav__link position-relative">
                        ...
                        ?>
                        <a href="?notif" class="nav__link" id="navnotif">
                            <i class='bx bxs-bell nav__icon'></i>
                            <span class="nav__name">Notification</span>
                        </a>
                        <?php
        ...
        <a href="assets/php/actions.php?logout" class="nav__link nav__logout">
