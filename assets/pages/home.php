<div class="container justify-content-center text-center box">
    <div class="row">
        <div class="col mt-4 embed-responsive embed-responsive-16by9">
            <h2>SMCC Alma Mater Song</h2>
            <br>
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/iTYxHnYkFQQ" frameborder="0"
