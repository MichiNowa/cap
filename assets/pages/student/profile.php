...
<div class="container mb-4">
  <?= showBanner('Re-fill up your Profile Information', 'Please complete your Middle Name.', BannerStatus::WARNING); ?>
</div>
<div class="container justify-content-center box">
  ...
  <form action="<?= pathname("/api/post/studentprofile") ?>" id="profile-form">
        ...
        <table>
          ...
          <tr>
            <td>
              ...
              <input class="form-control" type="file" id="formFile" name="profile_pic" multiple="false" accept=".png, .jpeg, .jpg" required>
            </td>
          </tr>
        </table>
      </div>
      <div class="col">
        ...
        <table>
          ...
          <tr>
            <td>
              <div class="select-wrapper">
                <select name="school_year" id="formSchoolYear" class="form-control" required>
        ...
        <table>
          ...
          <tr>
            <td>
              ...
              <div class="select-wrapper">
                <select name="academic_year" id="formAcademicYear" class="form-control" disabled>
    ...
    <div class="row text-center">
      ...
      <div class="col">
        <input type="text" name="middle_name" id="formMiddleName" value="<?= $user->getMiddleInitial() ?>" required class="form-control tw-uppercase">
      ...
      <div class="col table-responsive">
        <table class="table table-light">
          ...
          <tr>
            ...
            <td><input type="number" name="height" id="height" class="form-control" required></td>
        ...
        <table class="table table-light align-middle">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="father_middle_name" id="formFatherMiddleName" class="form-control" required>
              </td>
              <td>
                <label for="formMotherMiddleName">Middle Name</label>
              </td>
              <td>
                <input type="text" name="mother_middle_name" id="formMotherMiddleName" class="form-control" required>
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                <div class="select-wrapper">
                  <select name="father_education_attainment" id="formFatherEducationAttainment" class="form-control">
              ...
              <td>
                <div class="select-wrapper">
                  <select name="mother_education_attainment" id="formMotherEducationAttainment" class="form-control">
                    <option value="" selected disabled>Select Education Attainment</option>
                    <?php
                    foreach (getEducationAttaiments() as $educAttainment) {
                    ?>
            ...
            <tr>
              ...
              <td colspan="3">
                ...
                ?>
                  <input type="radio" name="parent_marital_status" id="formParentMaritalStatus<?= $n ?>" value="<?= $mstatus ?>" <?= $n === 0 ? "checked" : "" ?>>
    ...
    <div class="row mt-4">
      <div class="col-12">
        ...
        <div class="select-wrapper tw-max-w-32 ml-2">
          <select name="number_of_siblings" id="formNoOfSiblings" class="form-control bg-white text-center">
            <?php
            for ($i = 0; $i < 20; $i++) {
            ?>
      ...
      <div class="col table-responsive">
        <table class="table table-light align-middle">
          ...
          <tr>
            ...
            <td>
              Do you work at home?
              <input type="radio" name="workathome" id="formWorkAtHomeYes" value="Yes">
              <label for="formWorkAtHomeYes">Yes</label>
              <input type="radio" name="workathome" id="formWorkAtHomeNo" value="No" checked>
              <label for="formWorkAtHomeNo">No</label>
            </td>
            <td>
              What/s work?
              <input type="text" name="work" id="formWork" class="form-control" disabled>
            </td>
          ...
          <tr>
            ...
            <td>
              Do you have friends?
              <input type="radio" name="have_friends" id="formHaveFriendsYes" value="Yes">
              <label for="formHaveFriendsYes">Yes</label>
              <input type="radio" name="have_friends" id="formHaveFriendsNo" value="No" checked>
              <label for="formHaveFriendsNo">No</label>
            </td>
            <td>
              <span class="tw-text-sm tw-italic">if yes, why do you
                choose him/her</span>
              <input type="text" name="why_friend" id="formWhyFriend" class="form-control" disabled>
            </td>
          </tr>
        </table>
      </div>
      ...
      <div class="col table-responsive">
        <table class="table table-light align-middle">
          ...
          <tr>
            ...
            <td><input type="radio" name="indigenous_group" id="formIndigenousGroupYes" value="Yes">
              <label for="formIndigenousGroupYes">Yes</label>
            </td>
            <td><input type="radio" name="indigenous_group" id="formIndigenousGroupNo" value="No" checked>
              <label for="formIndigenousGroupNo">No</label>
            </td>
          </tr>
          <tr>
            <td class="text-end">If "YES", please specify: </td>
            <td colspan="2"><input type="text" name="indigenous_group_specify" id="formIndigenousGroupSpecify" class="form-control" disabled></td>
          </tr>
          <tr>
            <td>b. Are you differently abled?</td>
            <td><input type="radio" name="differently_abled" id="formDifferentlyAbledYes" value="Yes">
              <label for="formDifferentlyAbledYes">Yes</label>
            </td>
            <td><input type="radio" name="differently_abled" id="formDifferentlyAbledNo" value="No" checked>
              <label for="formDifferentlyAbledNo">No</label>
            </td>
          </tr>
          <tr>
            <td class="text-end">If "YES", please specify: </td>
            <td colspan="2"><input type="text" name="differently_abled_specify" id="formDifferentlyAbledSpecify" class="form-control" disabled></td>
          </tr>
          <tr>
            <td>c. Are you a solo parent?</td>
            <td><input type="radio" name="solo_parent" id="formSoloParentYes" value="Yes">
              <label for="formSoloParentYes">Yes</label>
            </td>
            <td><input type="radio" name="solo_parent" id="formSoloParentNo" value="No" checked>
              <label for="formSoloParentNo">No</label>
            </td>
          </tr>
          <tr>
            <td class="text-end">If "YES", please specify: </td>
            <td colspan="2"><input type="text" name="solo_parent_specify" id="formSoloParentSpecify" class="form-control" disabled></td>
          </tr>
        </table>
      </div>
    </div>
