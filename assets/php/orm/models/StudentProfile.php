...
class StudentProfile extends Model {
  ...
  public function getTechvocProgram(): string
  {
    return $this->techvoc_program;
  }
  ...
  public function getCreateTable(): array
  {
    return [
      ...
      "techvoc_program VARCHAR(255) DEFAULT ''",
