// @ts-ignore
import { React, ReactDOM, Swal } from "./imports.mjs";
// @ts-ignore
...
function AllAdminPage() {
    ...
    return (React.createElement("div", { className: "tw-container tw-mt-4" },
        ...
        React.createElement(Table, { columns: columns, items: items },
            React.createElement("div", null,
                React.createElement("button", { type: "button", className: "btn btn-primary", "data-bs-toggle": "modal", "data-bs-target": "#add-student-account-modal" },
